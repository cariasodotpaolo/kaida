...
<body>
    <div id="the-gallery" class="container">
        <!-- Page Heading/Breadcrumbs -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">The Gallery
                    <small></small>
                </h1>
                <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-6">
                <img class="img-responsive" src="../assets/kaida.jpg" alt="">
            </div>
            <div class="col-md-6">
                <h2>About Us</h2>
                <p>
                    ...
                    established Filipino artists since 2007. As the gallery continues to support painters,
                    sculptors and other media artists, it provides a platform for collaboration,
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; www.kaidacontemprary.com 2014</p>
                </div>
            </div>
        </footer>
